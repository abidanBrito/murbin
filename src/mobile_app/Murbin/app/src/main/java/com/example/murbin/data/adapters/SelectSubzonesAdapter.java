...
public class SelectSubzonesAdapter extends FirestoreRecyclerAdapter<Subzone, SubzonesListAdapter.ViewHolder> {
     ...
     */
    public SelectSubzonesAdapter(@NonNull FirestoreRecyclerOptions<Subzone> options, Context context) {
        super(options);
    ...
    public SubzonesListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater
                ...
                .inflate(
                        R.layout.recycler_select_subzones_fragment_element,
                        parent,
                        false
                );
